		...
		<div class="package-main">
			 ...
			 <div class="pack-bott">
			  <div class="col-md-3 package-grid">
			  	<img src="<%=basePath%>images/p1.jpg" alt="" class="img-responsive">
			  	<h4>温暖的气候</h4>
			  	
			  </div>
			  <div class="col-md-3 package-grid">
			  	<img src="<%=basePath%>images/p2.jpg" alt="" class="img-responsive">
			  	<h4>舒适的享受</h4>
		
			  </div>
			 <div class="col-md-3 package-grid">
			  	<img src="<%=basePath%>images/p3.jpg" alt="" class="img-responsive">
			  	<h4>都市生活</h4>
		
			  </div>
			  <div class="col-md-3 package-grid">
			  	<img src="<%=basePath%>images/p4.jpg" alt="" class="img-responsive">
			  	<h4>安静氛围</h4>
